...
public interface LpConstants {
	...
	final static double DEF_EPSB = 5.01e-7; /*
											 * for rounding RHS values to 0
											 * determine infeasibility basis
											 */
	final static double DEF_EPSEL = 1e-8; /*
											 * for rounding other values (vectors)
											 * to 0
											 */
	final static double DEF_EPSD = 1e-6; /*
											 * for rounding reduced costs to zero
											 */
	final static double DEF_EPSILON = 1e-3; /*
											 * to determine if a float value is
											 * integer
											 */
	...
	final static int ETA_START_SIZE = 10000; /*
												 * start size of array Eta.
												 * Realloced if needed
												 */
