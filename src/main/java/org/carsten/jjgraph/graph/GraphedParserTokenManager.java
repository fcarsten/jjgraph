 ...
 *
 */
/* Generated By:JavaCC: Do not edit this line. GraphedParserTokenManager.java */
...
public class GraphedParserTokenManager implements GraphedParserConstants {
	...
	public GraphedParserTokenManager(final SimpleCharStream stream) {
		if (SimpleCharStream.staticFlag)
			throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
		input_stream = stream;
	}

	public GraphedParserTokenManager(final SimpleCharStream stream, final int lexState) {
		this(stream);
		SwitchTo(lexState);
	}
