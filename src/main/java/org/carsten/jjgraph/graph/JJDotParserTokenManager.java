 ...
 *
 */
/* Generated By:JavaCC: Do not edit this line. JJDotParserTokenManager.java */
...
public class JJDotParserTokenManager implements JJDotParserConstants {
	...
	public static final String[] jjstrLiteralImages = { "", null, null, null, null, null, null, "\133", "\135", null,
			"\175", null, "\173", "\75", "\54", "\73", "\55\76", };
	...
	public JJDotParserTokenManager(final SimpleCharStream stream) {
		if (SimpleCharStream.staticFlag)
			throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
		input_stream = stream;
	}

	public JJDotParserTokenManager(final SimpleCharStream stream, final int lexState) {
		this(stream);
		SwitchTo(lexState);
	}
