 ...
 *
 */
/* Generated By:JavaCC: Do not edit this line. GraphedParser.java */
...
public class GraphedParser implements JJGraphParser, GraphedParserConstants {
	...
	@Override
	public boolean parse(final JJGraph g) throws IOException {
		graph = g;
	...
	JJNode getNodeForId(final long id) {
		...
		JJNode cn = nodeMap.get(ID);
		if (cn == null) {
			if ((nodeSerialMap.get(ID) == null) && (graph instanceof JJGraphImpl))
	...
	final public void nodeId() throws ParseException {
		...
		// nodeSerialMap.put(new Long(currentNode.getSerialNumber()),
		// currentNode);
		// }
	...
	final public void edgeId() throws ParseException {
		...
		final int id = Integer.parseInt(t.image);
		final JJNode target = getNodeForId(id); // (JJNode) nodeMap.get(ID);
	...
	final public void coordTriple() throws ParseException {
		...
		if (windows != null) {
			for (final Object element : windows) {
				final JJGraphicEdge ge = currentEdge.getGraphicEdge((JJGraphWindow) element);
	...
	final public void nodeInternal() throws ParseException {
		...
		case JJ_APP:
			...
			t = jj_consume_token(STRING);
			if ((currentNode != null) && (windows != null)) {
				for (final JJGraphWindow jjGraphWindow : windows) {
					final JJGraphWindow f = jjGraphWindow;
					final JJGraphicNode gn = currentNode.getGraphicNode(f);
	...
	public GraphedParserTokenManager token_source;
	...
	public GraphedParser(final java.io.InputStream stream) {
		jj_input_stream = new SimpleCharStream(stream, 1, 1);
		token_source = new GraphedParserTokenManager(jj_input_stream);
		token = new Token();
		jj_ntk = -1;
		jj_gen = 0;
		for (int i = 0; i < 16; i++)
	...
	public GraphedParser(final java.io.Reader stream) {
		jj_input_stream = new SimpleCharStream(stream, 1, 1);
		token_source = new GraphedParserTokenManager(jj_input_stream);
		token = new Token();
		jj_ntk = -1;
	...
	public GraphedParser(final GraphedParserTokenManager tm) {
		token_source = tm;
		token = new Token();
		jj_ntk = -1;
		jj_gen = 0;
	...
	public void ReInit(final GraphedParserTokenManager tm) {
		token_source = tm;
		token = new Token();
		jj_ntk = -1;
		jj_gen = 0;
