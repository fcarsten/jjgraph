...
public class JJPlotterFrame extends JFrame implements ChangeListener {
	private final JJPlotter panel;
	public JSlider opacitySlider;

	public JJPlotter getPanel() {
		return panel;
	}
	...
	public Component createComponents() {
		...
		opacitySlider = new JSlider(0, 100, 20);
		panel.setSlideVal(20);
	...
	public JJPlotterFrame(final JJPlotter fenster) {
		super("JJPlotter ");
		panel = fenster;
	}
