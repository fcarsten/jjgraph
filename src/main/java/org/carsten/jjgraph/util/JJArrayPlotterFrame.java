...
public class JJArrayPlotterFrame extends JFrame implements ChangeListener {
	private final JJArrayPlotter panel;
	JSlider opacitySlider;

	public JJArrayPlotter getPanel() {
		return panel;
	}
	...
	public JJArrayPlotterFrame(final JJArrayPlotter fenster) {
		super("JJArrayPlotter ");
		panel = fenster;
	}
